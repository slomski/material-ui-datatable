  ...
  return (
    <Grid container alignItems="center" justify="flex-end">
        ...
        (
          <Grid item>
            <Tooltip title={<FormattedMessage id="buttons.search" />}>
              <IconButton size="small" onClick={handleSearchClick} color="primary">
                <Search />
              </IconButton>
            </Tooltip>
          </Grid>
      ...
      { onFilter
        ...
        (
        <Grid item>
          <Tooltip title={<FormattedMessage id="buttons.table.filter" />}>
            <Button size="small" onClick={handleFilterVisibility} color="primary">
      ...
      { extraButtons && extraButtons().map((e, idx) =>
        (<Grid key={idx} item>{ e.button }</Grid>)) }
      { onClickNew &&
      <Grid item>
